...
export const createGroup = async (req, res) => {
  ...
  if(!name) {
    ...
    return res.status(400).json({error: true, message: 'Name must have be 5 characters long!'});
  }
  ...
  if(!description) {
    ...
    return res.status(400).json({error: true, message: 'Description must have be 10 characters long!'});
  }
...
export const createGroupMeetup = async (req, res) => {
  ...
  if(!title) {
    ...
    return res.status(400).json({error: true, message: 'Title must have be 5 characters long!'});
  }
